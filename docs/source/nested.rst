...
:class:`whoosh-reloaded.query.NestedParent` and/or :class:`whoosh-reloaded.query.NestedChildren`
...
The :class:`whoosh-reloaded.query.NestedParent` query type lets you specify a query for
...
The opposite of ``NestedParent`` is :class:`whoosh-reloaded.query.NestedChildren`. This
