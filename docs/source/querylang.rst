...
*default field* when you create the :class:`whoosh-reloaded.qparser.QueryParser` object.
...
``library`` within 5 words after ``whoosh-reloaded``::

    "whoosh-reloaded library"~5
