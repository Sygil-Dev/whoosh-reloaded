...
index (Positions format and standard_analyzer)::
...
(standard_analyzer by default) but only store term frequency::
...
:class:` whoosh.analysis.ngram_word_analyzer` analyzer, and
