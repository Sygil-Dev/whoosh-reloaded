...
You can use the :meth:`~whoosh-reloaded.searching.Hit.highlights` method on the
:class:`whoosh-reloaded.searching.Hit` object to get highlighted snippets from the
...
:class:`whoosh-reloaded.highlight.ContextFragmenter` (the default)
...
:class:`whoosh-reloaded.highlight.SentenceFragmenter`
...
:class:`whoosh-reloaded.highlight.WholeFragmenter`
...
:class:`~whoosh-reloaded.highlight.ContextFragmenter` lets you set the maximum
...
See the :mod:`whoosh-reloaded.highlight` docs for more information.
...
A scorer is a callable that takes a :class:`whoosh-reloaded.highlight.Fragment` object and
...
:class:`whoosh-reloaded.highlight.HtmlFormatter`
    Outputs a string containing HTML tags (with a class attribute)
    around the matched terms.

:class:`whoosh-reloaded.highlight.UppercaseFormatter`
    Converts the matched terms to UPPERCASE.

:class:`whoosh-reloaded.highlight.GenshiFormatter`
...
for the :class:`whoosh-reloaded.highlight.Formatter` class.
...
reusable :class:`whoosh-reloaded.highlight.Highlighter` object. Keyword arguments let
you change the ``fragmenter``, ``scorer``, ``order``, and/or ``formatter``::

    hi = highlight.Highlighter(fragmenter=my_cf, scorer=sds)

You can then use the :meth:`whoosh-reloaded.highlight.Highlighter.highlight_hit` method
...
To use :class:`whoosh-reloaded.highlight.PinpointFragmenter` and avoid re-tokenizing the
...
Set a :class:`whoosh-reloaded.highlight.PinpointFragmenter` as the fragmenter::
...
``fragmenter``
    A :class:`whoosh-reloaded.highlight.Fragmenter` object, see below.

``formatter``
    A :class:`whoosh-reloaded.highlight.Formatter` object, see below.

``top``
    The number of fragments to include in the output.

``scorer``
    A :class:`whoosh-reloaded.highlight.FragmentScorer` object. The only scorer currently
    included with Whoosh is :class:`~whoosh-reloaded.highlight.BasicFragmentScorer`, the
    default.
