...
Use a :class:`~whoosh-reloaded.analysis.StopFilter` and the ``minsize`` and ``maxsize``
...
Use the :class:`whoosh-reloaded.analysis.NgramWordAnalyzer` as the analyzer for the
...
See the documentation for the :class:`~whoosh-reloaded.analysis.NgramWordAnalyzer` class
