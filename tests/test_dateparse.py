from whoosh_reloaded.qparser.dateparse import *
...
def test_simple_dateparse(t=english.simple):
    ...
    assert_adatetime(
        t.date_from("20050510010835", basedate),
        year=2005,
        month=5,
        day=10,
        hour=1,
    ...
    assert_adatetime(
        t.date_from("2005.05.10  01:08:35", basedate),
        year=2005,
        month=5,
        day=10,
        hour=1,
...
def test_bundle(p=english.bundle):
    assert_adatetime(
        p.date_from("mar 29 1972 2:45am", basedate),
        year=1972,
        month=3,
        day=29,
        hour=2,
    ...
    assert_adatetime(
        p.date_from("16:10:45 14 February 2005", basedate),
        year=2005,
        month=2,
        day=14,
        hour=16,
    ...
    assert_adatetime(
        p.date_from("1985 sept 12 12:01", basedate),
        year=1985,
        month=9,
        day=12,
        hour=12,
    ...
    assert_adatetime(
        p.date_from("5pm 21st oct 2005", basedate), year=2005, month=10, day=21, hour=17
    )
    assert_adatetime(
        p.date_from("5:59:59pm next thur", basedate),
        year=2010,
        month=9,
        day=23,
        hour=17,
