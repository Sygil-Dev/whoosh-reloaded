...
def double_metaphone(text):
    ...
    while pos < length + 2:
        ...
        if ch in vowels:
            ...
            if (
                pos > (first + 1)
                and text[pos - 2] not in vowels
                and text[pos - 1 : pos + 2] == "ACH"
                and (
                    text[pos + 2] not in ["I", "E"]
                    or text[pos - 2 : pos + 4] in ["BACHER", "MACHER"]
                )
            ):
                next = ("K", 2)
            # special case 'CAESAR'
                ...
                if pos > first and text[pos : pos + 4] == "CHAE":
                    ...
                    pos == first
                    and (
                        text[pos + 1 : pos + 6] in ["HARAC", "HARIS"]
                        or text[pos + 1 : pos + 4] in ["HOR", "HYM", "HIA", "HEM"]
                    )
                    and text[first : first + 5] != "CHORE"
                ):
                    next = ("K", 2)
                # germanic, greek, or otherwise 'ch' for 'kh' sound
                elif (
                    text[first : first + 4] in ["VAN ", "VON "]
            ...
            if text[pos + 1] == "H":
                ...
                # Parker's rule (with some further refinements) - e.g., 'hugh'
                    ...
                    (pos > (first + 1) and text[pos - 2] in ["B", "H", "D"])
            ...
            # -ger-,  -gy-
                ...
                next = ("K", "J", 2)
            # italian e.g, 'biaggi'
            elif text[pos + 1] in ["E", "I", "Y"] or text[pos - 1 : pos + 3] in [
                "AGGI",
                "OGGI",
            ]:
                # obvious germanic
                if (
                    text[first : first + 4] in ["VON ", "VAN "]
                    or text[first : first + 3] == "SCH"
            ...
            # also, -sz- in slavic language altho in hungarian it is pronounced 's'
                ...
                if text[pos + 2] == "H":
                    ...
                    if text[pos + 3 : pos + 5] in ["OO", "ER", "EN", "UY", "ED", "EM"]:
                        ...
                        if (
                            pos == first
                            and text[first + 3] not in vowels
                            and text[first + 3] != "W"
                        ):
                            next = ("X", "S", 3)
                        else:
            ...
            if text[pos : pos + 4] == "TION":
                ...
                if (
                    text[pos + 2 : pos + 4] in ["OM", "AM"]
                    or text[first : first + 4] in ["VON ", "VAN "]
                    or text[first : first + 3] == "SCH"
                ):
                    next = ("T", 2)
                else:
            ...
            # Arnow should match Arnoff
                ...
                (pos == last and text[pos - 1] in vowels)
